...
// CONCATENATED MODULE: ./src/generateProjectTasks.js
...
// CONCATENATED MODULE: ./src/populateProjects.js
...
let src_projectArray = []
newProject("My Project", src_projectArray)
newProject("Double Test", src_projectArray)
createTask(src_projectArray, "My Project", "First Task", "tomorrow", "High", "Will this work", false)
createTask(src_projectArray, "My Project", "Second Task", "nigh", "Low", "Will thinighs work", false)
createTask(src_projectArray, "Double Test", "First in the second", "01/01/2029", "Urgent", "Double testy-westy", true)
console.log(src_projectArray)
console.log(generateProjectList(src_projectArray)) 
populateProjects(generateProjectList(src_projectArray), src_projectArray)
populateTasks(generateProjectTasks(src_projectArray, 0))
